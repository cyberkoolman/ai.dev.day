...
// Section 1: Just Testing Chat Completion --------------------------------------------------
...
//     try
//     {
//         ChatMessageContent chatResult = await chatCompletionService.GetChatMessageContentAsync(input, new OllamaPromptExecutionSettings(), kernel);
//         Console.Write($"\n>>> Result: {chatResult}\n\n> ");
//     }
//     catch (Exception ex)
//     {
...
// Section 2: Testing Function Calling with Plugins
builder.Services.AddOllamaChatCompletion(modelId, endpoint);
builder.Plugins
